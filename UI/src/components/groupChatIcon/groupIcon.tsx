...
interface IGroupIcon {
  usersClass?:string;
  centerUserClass?:string;
  circleClass?:string;
  className?:string;
  sizeClass?:string;
}

export default function GroupChatIcon (props:IGroupIcon) {
  return (
    <>
      <svg 
